      ...
      <div className="about_second">
        <div className="about_second_subcontainer">
          <div className="about_second_left">
            ...
            <div className="about_second_left_subtext">Our passion was borne out of the need to reduce the high rates of death and enormous burden that stems from a ravaging invasion of the non communicable diseases in Nigeria.</div>
